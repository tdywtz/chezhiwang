...
- (void)setErrorInfo:(NSArray *)errorInfo{
    ...
    for (int i = 0; i < errorInfo.count; i ++) {
        ...
        CZWLabel *leftLabel = [[CZWLabel alloc] init];
        leftLabel.textInsets = UIEdgeInsetsMake(2, 2, 2, 2);
        ...
        CZWLabel *rightLabel = [[CZWLabel alloc] init];
        rightLabel.textInsets = UIEdgeInsetsMake(2, 2, 2, 2);

...
-(void)createTableView{
    ...
    titleLabel.backgroundColor = colorBackGround;
...
-(NSAttributedString *)attWithString:(NSString *)string frame:(CGRect)frame{
    ...
    [mutableAtt addAttribute:NSForegroundColorAttributeName value:colorLightBlue range:NSMakeRange(0, mutableAtt.length)];

...
-(void)makeUI{
    ...
    YYLabel *tishilabel = [[YYLabel alloc] initWithFrame:CGRectMake(0, 0, WIDTH, 30)];
    tishilabel.textContainerInset = UIEdgeInsetsMake(10, 13,10, 10);
    tishilabel.backgroundColor = colorBackGround;
    tishilabel.font = [UIFont systemFontOfSize:13];
    tishilabel.textColor = colorLightGray;
    tishilabel.text = @"以下信息全是必填选项，请您认真填写以下内容";
    NSMutableAttributedString *att = [[NSMutableAttributedString alloc] initWithString:@"以下信息全是必填选项，请您认真填写以下内容"];
    NSMutableAttributedString *attachment = [NSMutableAttributedString yy_attachmentStringWithContent:[UIImage imageNamed:@"auto_common_提示"] contentMode:UIViewContentModeScaleToFill attachmentSize:CGSizeMake(20, 20) alignToFont:[UIFont systemFontOfSize:13] alignment:YYTextVerticalAlignmentCenter];
    [att insertAttributedString:attachment atIndex:0];
    tishilabel.attributedText = att;

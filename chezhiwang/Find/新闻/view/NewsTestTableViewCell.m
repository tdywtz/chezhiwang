...
- (void)drawRect:(CGRect)rect{
    ...
    CGContextSetStrokeColorWithColor(context, colorYellow.CGColor);
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _customTitleLabel.font = [UIFont systemFontOfSize:13];
...
-(void)makeUI{
    ...
    [iconImageView makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(10);
        make.top.equalTo(titleLabel.bottom).offset(8);

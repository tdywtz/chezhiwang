...
-(void)createTableHeaderView{
    ...
    [classifyButton setTitleColor:[UIColor colorWithRed:0/255.0 green:125/255.0 blue:184/255.0 alpha:1] forState:UIControlStateNormal];
    classifyButton.titleLabel.font = [UIFont systemFontOfSize:[LHController setFont]-3];

...
-(NSInteger)selectCollectNumber{
    return   [self selectAllFromCollect:collectTypeAnswer].count+[self selectAllFromCollect:collectTypeCompalin].count+[self selectAllFromCollect:collectTypeNews].count;
